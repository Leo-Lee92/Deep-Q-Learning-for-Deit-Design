...
from keras.layers import Densek
...
for k in range(num_of_samples):
    ...
    while not Done: # Done이 False인 한
        ...
        if i != 0 and i % 300 == 0 or Done == True:
            ...
            plt.savefig(Path('/home/messy92/Leo/Project_Gosin/Q_Learning/Code/gen_sample/Last_Layer_Weight_MSE.png'))


    if ((k != 0) and (k % 10 == 0)):
        # action_reward_distribution.plot(kind = 'bar')
        action_reward_distribution.to_csv(Path('/home/messy92/Leo/Project_Gosin/Q_Learning/Code/gen_sample/action_reward.csv'))
        action_MAX_reward_distribution.to_csv(Path('/home/messy92/Leo/Project_Gosin/Q_Learning/Code/gen_sample/Action_Per_Reward_Depth.csv'))
        ...
        Action_Reward_PATH.to_csv(Path('/home/messy92/Leo/Project_Gosin/Q_Learning/Code/gen_sample/Action_Reward_PATH.csv'))
    ...
    if (k == (num_of_samples - 1)):
        ...
        The_Message.to_csv(Path('/home/messy92/Leo/Project_Gosin/Q_Learning/Code/gen_sample/Finish_Letter.csv'))
